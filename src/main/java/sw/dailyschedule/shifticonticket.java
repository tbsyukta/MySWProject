...
public class shifticonticket {
	...
	public void deptschedule() throws InterruptedException {
		...
		WebElement loading = driver.findElement(By.xpath("//*[@id='MainContent_LoadingPanel']//tr"));
		...
		Thread.sleep(2000);
		//WebElement tdcolumn = driver.findElement(By.xpath("//*[@id='MainContent_DeptScheduleCallback_deptschedule']/tbody/tr/td"))
		//staffname.get(randomStaff).findElement(By.xpath("//*[@id='MainContent_DeptScheduleCallback_deptschedule']//tbody//tr//td[5]")).click();
		
		try {
			
			List<WebElement> staffname1 = driver.findElements(
					By.xpath("//table[contains(@id,'MainContent_DeptScheduleCallback_deptschedule')]//tbody//tr"));
			staffname1.get(randomStaff).findElement(By.xpath("//*[@id='MainContent_DeptScheduleCallback_deptschedule']//tbody//tr//td[5]")).click();
		
		}
		catch(Exception e) {
			List<WebElement> staffname2 = driver.findElements(
					By.xpath("//table[contains(@id,'MainContent_DeptScheduleCallback_deptschedule')]//tbody//tr"));
			staffname2.get(randomStaff).findElement(By.xpath("//*[@id='MainContent_DeptScheduleCallback_deptschedule']//tbody//tr//td[5]")).click();
		
		}
	///	WebElement tdcolumn = driver.findElement(By.xpath("//*[@id='MainContent_DeptScheduleCallback_deptschedule']/tbody/tr/td"))
	//	staffname.get(randomStaff).findElement(By.xpath("")).click();
		////table[contains(@id,'MainContent_DeptScheduleCallback_deptschedule')]//tbody//td[td number] for partcular date want select 
		////*[@id="MainContent_DeptScheduleCallback_deptschedule"]/tbody/tr/td
		//*[@id='MainContent_DeptScheduleCallback_deptschedule']/tbody/tr/td[5]
		Thread.sleep(3000);
...
//		actions.moveToElement(addicon).perform();
	...
	//	WebElement rightclickforshiftedit = driver.findElement((By.xpath("//*[@id='MainContent_DeptScheduleCallback_deptschedule']/tbody/tr/td/span[" + randomStaff1 + "]")));
		...
		List<WebElement> editshiftlist = driver.findElements(By.xpath("/html/body/ul/li[7]/ul/li/span"));
		...
		for (WebElement shifttypelabel : editshiftlist) {
			...
			Thread.sleep(2000);
			WebElement contcatepath = driver.findElement(By.xpath("//li[@class='context-menu-item']//span[contains(text(),'"+nameoftype+"')]"));
