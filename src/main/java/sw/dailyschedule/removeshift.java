...
public class removeshift {
	...
	@Test(priority = 1)
	public void removeshift() throws InterruptedException {
...
//    	actions.moveToElement(menuOption).perform();
		...
		WebElement removeshift = driver.findElement(By.xpath("//img[contains(@title,'Remove staff')]"));
		removeshift.click();
		Thread.sleep(2000);

	
//		WebElement yremovepopup = driver.findElement(By.xpath("(//div[contains(@id,'btnDeleteOK')])[1]"));
//		yremovepopup.click();
	
		WebElement nremovepopup = driver.findElement(By.xpath("(//div[contains(@id,'popupRemove_btCancel')])[1]"));
		nremovepopup.click();
